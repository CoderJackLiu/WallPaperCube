### ui_components.py
from tkinter import Frame, Label, Button, Canvas, Scrollbar, filedialog, IntVar, StringVar, ttk
...
class AppUI:
    ...
    def setup_oss_tab(self):
        if self.oss_ui_handler != None:
            self.oss_ui_handler.setup_oss_ui(self.oss_tab)
            # # 首次进入时加载OSS壁纸
            self.oss_ui_handler.select_oss_folder()
