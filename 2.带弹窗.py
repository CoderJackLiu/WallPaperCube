...
def display_images(folder, canvas, scrollable_frame, page, images_per_page):
...
def start_application():
    def select_folder():
        ...
        if folder:
            ...
            display_images(folder, canvas, scrollable_frame, current_page.get(), images_per_page)
    ...
    def next_page():
        if folder_path.get():
            ...
            if current_page.get() < max_page:
                ...
                display_images(folder_path.get(), canvas, scrollable_frame, current_page.get(), images_per_page)
